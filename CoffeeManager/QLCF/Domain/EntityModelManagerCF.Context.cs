...
namespace QLCF.Domain
{
    ...
    public partial class CFMEntities : DbContext
    {
        ...
        public virtual DbSet<BehaviorUser> BehaviorUsers { get; set; }
        ...
        public virtual ObjectResult<USP_GetListProductByName_Result> USP_GetListProductByName(string nameinput)
        {
            var nameinputParameter = nameinput != null ?
                new ObjectParameter("nameinput", nameinput) :
                new ObjectParameter("nameinput", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<USP_GetListProductByName_Result>("USP_GetListProductByName", nameinputParameter);
        }
    }
}
